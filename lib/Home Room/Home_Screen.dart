  ...
  initState()
  {
    setState(() {
      ...
      if(CurrentAvatar == Avatar1_Path)
        ...
        Select_Avatar(2);
      else if(CurrentAvatar == Avatar3_Path)
        Select_Avatar(3);
  ...
  Widget Build_Update() {
    return Container(
      ...
      child: ElevatedButton(
        ...
        onPressed: (){
          update_UserData(Selected_Avatar, UserName_Controller.text, Selected_Color);
        },
      ),
    );
  }
          ...
          panelBuilder: (controller) => ListView(
            ...
            children: [
              ...
              Row(
                children: <Widget>[
                  IconButton(
                    icon: Image.asset('icons/color1.png', color: Color1_BoarderColor, colorBlendMode: BlendMode.multiply),
                    onPressed: (){ setState(() {
                      Select_Color(1);
                    });  },),
                  IconButton(
                    icon: Image.asset('icons/color2.png', color: Color2_BoarderColor, colorBlendMode: BlendMode.multiply),
                    onPressed: (){ setState(() {
                      Select_Color(2);
                    });  },),
                  IconButton(
                    icon: Image.asset('icons/color3.png', color: Color3_BoarderColor, colorBlendMode: BlendMode.multiply),
                    onPressed: (){ setState(() {
                      Select_Color(3);
                    });  },),
                ],
